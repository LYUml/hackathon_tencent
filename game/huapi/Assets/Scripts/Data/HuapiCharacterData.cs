...
{
    /// <summary>
    /// 角色档案数据（UI用）：ScriptableObject，驱动角色档案显示
    /// 对应 hackathon 仓库的 HuaPi.UI.Data.CharacterData
    /// </summary>
    [CreateAssetMenu(fileName = "HuapiCharacterData", menuName = "画皮/UI角色数据")]
    public class HuapiCharacterData : ScriptableObject
    {
        [Header("基本信息")]
        [Tooltip("角色唯一ID")]
