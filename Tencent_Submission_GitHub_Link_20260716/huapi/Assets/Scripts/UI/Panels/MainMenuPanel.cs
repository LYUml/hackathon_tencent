...
namespace TXGame
{
    ...
    public class MainMenuPanel : PanelBase
    {
        ...
        [SerializeField] private Color hoverColor = new Color(0.545f, 0.125f, 0.125f, 0.9f);
        ...
        private void SetupMenuItems()
        {
            ...
            if (subtitleText != null)
            {
                ...
                subtitleText.color = new Color(0.353f, 0.227f, 0.165f, 0.6f);
            }
            ...
            if (bottomInfoText != null)
            {
                ...
                bottomInfoText.color = new Color(0.239f, 0.082f, 0.094f, 0.4f);
            }
        ...
        private class MenuItemHover : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
        {
